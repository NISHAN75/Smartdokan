...
/**
 * Add/Edit Category form. Pass `initialData` (a category object) to edit,
 * or omit it to create. Follows the same plain useState + manual
 * validation pattern already used by Login/Register, rather than
 * introducing a form library for a 3-field form.
 */
const CategoryFormModal = ({ open, onClose, onSubmit, initialData, isSubmitting }) => {
