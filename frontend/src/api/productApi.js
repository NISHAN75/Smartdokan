...
export const createProductRequest = async ({ name, categoryId, description, status }) => {
...
export const updateProductRequest = async ({ id, name, categoryId, description, status }) => {
